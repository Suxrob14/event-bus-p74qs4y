    ...
    Event Bus P74qs4y
    =================
    Production-ready REST API component built to throttle web requests at scale.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Production-ready REST API component built to throttle web requests at scale.")
